...
| 10 | Etsy başlık düzeltmesi | **ONAY BEKLIYOR** | 54 ilan | `wallpaper_title_description_approval.csv` |
| 20 | Wallpaper açıklama düzeltmesi | **ONAY BEKLIYOR** | 78 ilan | `wallpaper_title_description_approval.csv` |
| 30 | Duplicate arşivleme | **ONAY BEKLIYOR** | 722 dosya / 0,99 GB / 200 grup | `duplicate_archive_plan.csv` |
| 40 | Etsy Ads veri içe alma | **GIRDI BEKLIYOR** | Gerçek Etsy Ads CSV | `ads_import_template.csv` |
| 50 | Mağaza paneli P0-P1 düzeltmeleri | **ONAY BEKLIYOR** | P0-P1 maddeleri | `store_conversion_actions.md` |
| 60 | Sosyal medya / Metricool yayını | **ONAY BEKLIYOR** | 546 satır | `platform_content_final.csv` |
