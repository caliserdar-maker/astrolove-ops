...
RU_GOVDE = """Именной постер для пары со знаками зодиака {A} и {B}, с вашими двумя именами и короткой надписью. Оригинальный дизайн AstroLove объединяет оба знака в один символ. Печатаем на хлопковой бумаге Hahnemühle Photo Rag 308 г/м² и отправляем без рамы.
...
16 РАЗМЕРОВ
8 × 10, 11 × 14, 12 × 16, 12 × 18, 16 × 20, 16 × 24, 18 × 24, 20 × 30, 24 × 30, 24 × 32, 24 × 36 и 30 × 40 дюймов, а также A4, A3, A2 и A1. Посмотрите фото с таблицей размеров.

ПЕЧАТАЕМ ПОД ЗАКАЗ
Каждый постер печатается под заказ нашим партнером Prodigi. В зависимости от размера отправляем в плоской упаковке или в тубусе. Сроки доставки для вашего адреса указаны в карточке товара.

ВОЗВРАТ
Каждый постер персонализирован, поэтому мы не принимаем возвраты и обмены. Если постер придет поврежденным, пришлите фото в течение 7 дней, и мы бесплатно напечатаем новый.

Хороший подарок на годовщину, свадьбу или День святого Валентина для пары со знаками зодиака {A} и {B}."""
